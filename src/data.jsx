export const fletData = [
  ...
  {
    title: "Soporte toda la semana",
    image: "./fle-comunication.png",
    description:
      "Nos comprometemos con brindar soporte a nuestros clientes respecto a los reportes de trabajos realizados cualquier incidencia.",
    moreInfo: "Aprender más...",
  },
  {
    title: "Alto rendimiento",
    image: "./flet-rend.webp",
    description:
      "Brindamos un servicio de alto rendimiento cubriendo más 90% de la demanda en el mercado.",
    moreInfo: "Aprender más...",
  },
];

export const fletHeroData = [
  {
